...
import {FileElement} from '../../finder/interfaces/file-element';
...
export class UploadComponent implements OnInit, OnChanges {
    ...
    files = [];
    @Input() public targetPath: FileElement;
    ...
    onClick() {
        if (this.targetPath.uuid === undefined || this.targetPath.uuid === null) {
            this.targetPath.uuid = '/';
        }
    ...
    uploadFile(file) {
        ...
        formData.append('target', this.targetPath.uuid);
